  ...
  return (
    <div className="flex flex-col gap-4">
      <p className="text-sm text-text-muted">
        手动添加 {isAnthropic ? "Anthropic" : "OpenAI"} 兼容模型，或从已连接供应商的 /models 端点导入。
      </p>
      ...
      <div className="flex items-end gap-2 flex-wrap">
        <div className="flex-1 min-w-[240px]">
          ...
          <input
            ...
            placeholder={isAnthropic ? "claude-sonnet-4-6" : "gpt-5.2"}
      ...
      {!canImport && <p className="text-xs text-text-muted">添加连接后可以从 /models 自动导入模型。</p>}
