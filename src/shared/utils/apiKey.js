...
const DEFAULT_API_KEY_SALT = ["endpoint", "proxy", "api", "key", "secret"].join("-");
const API_KEY_SALT = process.env.AGENT_ROUTE_API_KEY_SALT || process.env.API_KEY_SECRET || DEFAULT_API_KEY_SALT;
